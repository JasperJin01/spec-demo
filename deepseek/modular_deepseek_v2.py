...
# 注意：Llama4TextRotaryEmbedding 可能不存在，我们使用 LlamaRotaryEmbedding 替代
from transformers.models.llama.modeling_llama import LlamaRotaryEmbedding as Llama4TextRotaryEmbedding
